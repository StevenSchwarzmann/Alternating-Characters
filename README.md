The purpose for me of this code war was to better understand of a soultion that was not a simple loop. For this solution, I chose to use the filter method.
